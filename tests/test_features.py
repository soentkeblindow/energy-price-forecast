...
def test_rolling_mean_knowledge_time() -> None:
    ...
    # CET = UTC+1 in January, so 22:00 UTC = 23:00 CET → local day = 2024-01-02.
    # DA_FIXED formula: _local_day → 2024-01-02 00:00 CET → UTC → 2024-01-01 23:00 → normalize → 2024-01-01 00:00 UTC.
    expected_kt = pd.Timestamp("2024-01-01 00:00", tz="UTC")
